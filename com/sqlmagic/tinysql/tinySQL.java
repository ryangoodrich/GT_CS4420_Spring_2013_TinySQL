...
public abstract class tinySQL {
  ...
  static tinySQLTable insertTable=null;
  tinySQLWhere wc;
 ...
 */
      tsResultSet rs = null;
      tinySQLTable jtbl;
      tinySQLPreparedStatement pstmt=null;
 ...
 */
            ...
            if ( tableName != null &  !actionType.equals("DROP_TABLE") &
 ...
 */
      for ( i = 0; i < t.size(); i++ )
      {
         jtbl = (tinySQLTable)tables.get(t.elementAt(i));
         jtbl.close();
      }
/*
 *    return a result set
