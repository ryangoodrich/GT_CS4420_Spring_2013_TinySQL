...
public class tinySQLParser
{
   ...
   String lastKeyWord=null,orderType=null;
   String oldColumnName=null,newColumnName=null;
      ...
      throws tinySQLException
   {
      ...
      FieldTokenizer ft;
      Reader r;
      String nextToken,upperField,nextField,keyWord=null;
 ...
 */
      ...
      try
      {
         ...
         if ( keyWord != null ) setPhrase(keyWord,cmdBuffer.toString());
         addAction();
         if ( tinySQLGlobals.PARSER_DEBUG )
 ...
 */
         ...
         for ( i = 0; i < tableList.size(); i++ )
         {
            jtbl = (tinySQLTable)tables.get(tableList.elementAt(i));
/*
 ...
 */
         ...
         if ( orderType != null ) newAction.put("ORDER_TYPE",orderType);
