...
class tsColumn implements Cloneable
{
   ...
   String functionArgString = null;  // Function arguments
   Vector functionArgs = null; // Function arguments as columns
 ...
 */
      ...
      throws tinySQLException
   {
      int i;
      tsColumn argColumn;
      if ( isConstant | inputColumnName == null ) return;
 ...
 */
            if ( inputColumnValue == null ) return;
 ...
 */
         ...
         if ( type == Types.INTEGER ) thisValue = intValue;
         else if ( type == Types.FLOAT ) thisValue = floatValue;
         if ( inputType == Types.INTEGER )
            inputValue = inputColumn.intValue;
         else if ( inputType == Types.FLOAT )
            inputValue = inputColumn.floatValue;
 ...
 */
   public String getString()
   {
      ...
      if ( type == Types.CHAR | type == Types.DATE | type == -1 ) {
         ...
         if ( intValue == Integer.MIN_VALUE ) return null;
         return Integer.toString(intValue);
      } else if ( type == Types.FLOAT ) {
         if ( floatValue == Float.MIN_VALUE ) return null;
